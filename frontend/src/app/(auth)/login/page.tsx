...
import { Cpu, Loader2, Mail, ArrowRight, ShieldCheck, HelpCircle } from "lucide-react";
      ...
      >
        <div className="border border-border/60 bg-card rounded-2xl p-8 shadow-[0_4px_30px_rgba(0,0,0,0.01)] hover:shadow-xl duration-300 relative overflow-hidden">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-foreground font-display">Sign In</h1>
            <p className="text-muted-foreground text-xs mt-1 leading-relaxed">
              Enter your credentials or use local secure sign-in
            </p>
          </div>
          ...
          <div className="mt-6 text-center text-xs text-muted-foreground">
            Don't have an account? <Link href="/signup" className="text-primary hover:text-primary/85 font-medium underline underline-offset-4 duration-300">Sign Up</Link>
          </div>
        </div>
      </motion.div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <p className="text-[11px] text-muted-foreground mt-1">to continue to Cognitive OS</p>
              </div>

              {isGoogleLoading ? (
                <div className="py-8 flex flex-col items-center justify-center gap-3">
                  <Loader2 className="w-8 h-8 animate-spin text-primary" />
                  <p className="text-xs text-muted-foreground font-medium animate-pulse">Authenticating securely...</p>
                </div>
              ) : (
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-border/30 flex items-start gap-2.5">
                    ...
                    <p className="text-[9px] text-muted-foreground leading-normal font-light">
                      Cognitive OS local-first environment authenticates standard Google accounts directly with database residency isolated entirely to your physical machine.
                    </p>
                  </div>
                </div>
              )}
